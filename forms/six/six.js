...
let timesRun = Number(prompt('How many times do you want to run the program?'))

let r = 0

while (r < timesRun) {
  let size = prompt('How large is your dog? (standard, miniature, or toy): ')
  let sizeSmall = size.toLowerCase()
  switch(sizeSmall) {
    case 'toy' :
    ...
    case 'standard' :
      ...
      break;
    default :
      alert("Not an accepted size. Try again.")
}
